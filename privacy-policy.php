...
<!-- Hoja de estilos. -->
<style>
	<?php include __DIR__ . '/css/privacy-policy.css'; ?>
</style>

<!-- Cuerpo principal. -->
<div class="privacyPolicyImage"></div>

<div class="pp-main-cnt">
	<h4>POLÍTICA DE PRIVACIDAD</h4>
	<div class="vsep10"></div>
	<p>
		La presente Política de Privacidad establece los términos en que codigoweb.net
	...
	<p>
		...
		contacto como su dirección de correo electrónico o información demográfica. Así mismo cuando
	...
	<div class="vsep10"></div>
	<p>
		codigoweb.net está altamente comprometido para cumplir con el compromiso de mantener
	...
	<p>
		...
		que usted así lo quiera y la proporcione directamente.  Usted puede aceptar o negar el uso
		...
		ordenador para declinar las cookies.  Si se declinan es posible que no pueda utilizar algunos
	...
	<p>
		...
		vez que usted de clic en estos enlaces y abandone nuestra página, ya no tenemos control sobre
		el sitio al que es redirigido y por lo tanto no somos responsables de los términos o
	...
	<div class="vsep10"></div>
	<p>
		codigoweb.net Se reserva el derecho de cambiar los términos de la presente
